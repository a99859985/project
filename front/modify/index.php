    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-info border-bottom shadow-sm">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <?php
          ...
          echo "<a class=p-2 text-dark href='membercenter.php' style='color: #000000'>會員中心</a>";
...
?>
    <div class="container" >
      ...
      echo"<input type=text name=member_password  class=form-control maxlength=30 placeholder=密碼 required=required value='' >";
      
      echo"<label for=inputPassword class=sr-only>Password</label>";
      echo"<input type=text name=member_passwordconfirm  class=form-control maxlength=30 placeholder=再次確認密碼 required=required value=''>";
      ?>
