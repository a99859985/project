    ...
    <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
      ...
      <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        ...
        <div class="col-md-6 px-0">
          ...
          echo"<p class=lead mb-0><a  class=text-white font-weight-bold>現金: $row[3]<br>點數:  $row[4]<br></a></p>";

          ?>
          <a   class="p-2 text-light"  >沒有錢了嗎?</a>

          <a   href='../money/index.php' class="p-2 text-danger" >儲值去</a>
        </div>
      </div>
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start" style="background-color:gray;">
              ...
              <h3 class="mb-0">
                <a style="color:white">修改會員資料</a>
              </h3>
              <div style="color:white">Modify member information</div>
              <p style="color:white">修改 密碼</p>
              <?php
                echo "<form name=form method=post action=index.php>";
                echo "<input type=hidden name=id value=$id>";
                echo "<button type=submit onclick=Check(event) style=font-size:10pt;width:90px;height:30px>前往修改</button>";
                echo "</form>";
              ?>
            </div>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start" style="background-color:gray;">
              <h3 class="mb-0">
                <a style="color:white">查詢訂單</a>
              </h3>
              <div style="color:white">checking order</div>
              <p style="color:white">查看以往訂單</p>
              <?php
                echo "<form name=form method=post action=../order/index.php>";
                echo "<input type=hidden name=id value=$id>";
                echo "<button type=submit onclick=Check(event) style=font-size:10pt;width:90px;height:30px>前往查看</button>";
                echo "</form>";
              ?>
            </div>
      ...
      <div class="row mb-2">
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start" style="background-color:gray;">
              ...
              <h3 class="mb-0">
                <a  style="color:white">回收中心</a>
              </h3>
              <div style="color:white">recycle system</div>
              <p style="color:white">回收賺點數</p>
              <?php
                echo "<form name=form method=post action=../recycle/checkrecycle.php>";
                echo "<input type=hidden name=id value=$id>";
                echo "<button type=submit onclick=Check(event) style=font-size:10pt;width:90px;height:30px>回收去</button>";
                echo "</form>";
              ?>
            </div>
        ...
        <div class="col-md-6">
          <div class="card flex-md-row mb-4 shadow-sm h-md-250">
            <div class="card-body d-flex flex-column align-items-start" style="background-color:gray;">
              <h3 class="mb-0">
                <a  style="color:white">購物中心</a>
              </h3>
              <div  style="color:white">Shopping Mall</div>
              <p style="color:white">前往購物中心</p>
              <?php
                echo "<form name=form method=post action=../item/index.php>";
                echo "<input type=hidden name=id value=$id>";
                echo "<button type=submit onclick=Check(event) style=font-size:10pt;width:90px;height:30px>開始購物</button>";
                echo "</form>";
              ?>
            </div>
